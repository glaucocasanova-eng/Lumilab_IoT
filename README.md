...
Entretanto, no projeto físico original, o sensor foi implementado utilizando um LDR discreto associado a um resistor de 10kΩ em configuração de divisor de tensão, permitindo a leitura analógica pelo ESP32, e o passo a passo é seguindo o projeto físíco original.»
